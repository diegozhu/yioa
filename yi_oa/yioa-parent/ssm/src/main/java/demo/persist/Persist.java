...
//tag::snippetB[]
	public void change(int order, String event) {
		...
		boolean bool = handler.handleEventWithState(MessageBuilder.withPayload(event).setHeader("order", order).build(), "PLACED");

		System.out.print("############ onPersist: "+bool);
	}
	...
	private class LocalPersistStateChangeListener implements PersistStateChangeListener {
		...
		public void onPersist(State<String, String> state, Message<String> message,
			...
			if (message != null && message.getHeaders().containsKey("order")) {
				...
				System.out.print("############ onPersist: "+order);
